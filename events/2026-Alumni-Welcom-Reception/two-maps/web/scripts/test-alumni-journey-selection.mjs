...
const profile = {
  ...
  currentRole: "Founder",
  photoUrl: "/avatars/originals/alumni-frank-ji-2020.jpg",
  stops: [
...
assert.equal(original.photoUrl, "/avatars/originals/alumni-frank-ji-2020.jpg");
...
assert.equal(staged.photoUrl, "/avatars/stages/alumni-frank-ji-2020/step-2.jpg");
